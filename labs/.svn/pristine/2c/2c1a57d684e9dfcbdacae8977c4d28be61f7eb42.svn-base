# 周雪振 5141509091
# 实现了对iaddq指令的支持
#   由于作业程序中使用较多的jle和iandq组合，故单独处理jle和iandq组合, 来提高程序性能！！！
...
word f_pc = [
#单独处理jle和iandq组合, 来提高程序性能！
        M_icode==IJXX && M_ifun==1 && D_icode!=1: F_predPC;
        M_icode==IJXX && M_ifun==1 && M_Cnd: M_valE;

	# Mispredicted branch.  Fetch at incremented PC
	M_icode == IJXX && M_ifun!=1 && !M_Cnd : M_valA;
...
word f_predPC = [
#单独处理jle和iandq, 来提高程序性能！
	f_icode in {  ICALL } : f_valC;
        f_icode == IJXX && f_ifun!=1: f_valC;
	1 : f_valP;
];
...
bool D_bubble =
	# Mispredicted branch
#单独处理jle和iandq组合, 来提高程序性能！
        (E_icode==IJXX && E_ifun==1 && e_Cnd && D_icode!=IIADDQ) ||
        (E_icode==IJXX && E_ifun==1 && e_Cnd && D_icode==IIADDQ && D_valP!=E_valC)||
